...
{
    internal class CLIEcho : CLICommand
    {
    ...
    internal class CLIClearScreen : CLICommand
    {
    ...
    internal class CLICallPSOD : CLICommand
    {
    ...
    internal class CLIInfo : CLICommand
    {
    ...
    internal class CLIDir : CLICommand
    {
    ...
    internal class CLICD : CLICommand
    {
    ...
    internal class CLIHelp : CLICommand
    {
        ...
        public override void Execute(List<string> args, Terminal instance)
        {
            ...
            else if (args.Count == 2)
            {
                ...
                CLICommand command = AbusaCLI.FindCommand(commandName);
                if (command != null)
                {
                    instance.curcol = Color.Green;
    ...
    internal class CLICat : CLICommand
    {
